            ...
            <Hero>
                <Hero.Content className="flex-col lg:flex-row">
                    <div className="text-center space-y-7">
                        ...
                        <p className="space-y-7">Let us know how we can help. Contact MindGarden support team by filling out contact details to your right, or you can directly email us.</p>
                        <a className="space-y-7" href="tel:18889580569">+1 (888) 958 0569</a><br></br>
                        <a className="space-y-7" href="mailto:info@mindgarden.ml">info@mindgarden.ml</a>
                        <p>
