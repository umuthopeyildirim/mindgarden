            ...
            <div className="flex justify-center self-center z-10">
                <div className="p-12 bg-gradient-to-b from-gray-900 via-gray-900 to-purple-800 mx-auto rounded-3xl w-96 ">
                    ...
                    <div className="space-y-6">
                        ...
                        <Button onClick={handleRecovery} type="submit" className="w-full flex justify-center bg-purple-800 hover:bg-purple-700 text-gray-100 p-3 rounded-lg tracking-wide font-semibold cursor-pointer transition ease-in duration-500">
                            Register
                        </Button>
                    </div>
                </div>
